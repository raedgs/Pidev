 ...
 */
final class Version20220309163154 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE service_av ADD user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE service_av ADD CONSTRAINT FK_D63C52A6A76ED395 FOREIGN KEY (user_id) REFERENCES `user` (id)');
        $this->addSql('CREATE INDEX IDX_D63C52A6A76ED395 ON service_av (user_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE service_av DROP FOREIGN KEY FK_D63C52A6A76ED395');
        $this->addSql('DROP INDEX IDX_D63C52A6A76ED395 ON service_av');
        $this->addSql('ALTER TABLE service_av DROP user_id, CHANGE nomdeproduit nomdeproduit VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
