...
class ResetPasswordController extends AbstractController
{
    ...
    public function checkEmail(): Response
    {
        ...
        $this->addFlash('Email_Sent', 'Email Sent! Please check your inbox.');
    ...
    public function reset(Request $request, UserPasswordEncoderInterface $userPasswordEncoder, string $token = null): Response
    {
        ...
        return $this->render('user/recover-password-v2.html.twig', [
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ->from(new Address('anonym14637@gmail.com', 'BrainTech'))
            ->to($user->getEmail())
