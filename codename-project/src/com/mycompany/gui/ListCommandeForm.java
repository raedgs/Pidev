...
//        if(image.getHeight() < size) {
    ...
    private void addButton(Image img,Commande com , Resources res) {
        ...
        Label montant = new Label("Montant : "+com.getMontant(),"NewsTopLine2");
        //Label dateTxt = new Label("montant : "+com.getDate(),"NewsTopLine2");
      //  Label etatTxt = new Label("Etat : "+com.getEtat(),"NewsTopLine2" );
        Label qte = new Label("quantite : "+com.getQte(),"NewsTopLine2" );
        createLineSeparator();
     ...
     if (role.equals("[ROLE_CLIENT, ]"))
     {
         cnt.add(BorderLayout.NORTH,BoxLayout.encloseY(
             ...
             //   BoxLayout.encloseX(dateTxt),
                BoxLayout.encloseX(montant,qte)));
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce commande ?","Annuler","Oui")) {
                ...
                //n3ayto l suuprimer men service Commande
       ...
       lModifier.addPointerPressedListener(l -> {
        ...
        cnt.add(BorderLayout.NORTH,BoxLayout.encloseY(
              ...
              // BoxLayout.encloseX(montant),
             //   BoxLayout.encloseX(dateTxt),
                BoxLayout.encloseX(montant,qte,lModifier,lSupprimer)));
