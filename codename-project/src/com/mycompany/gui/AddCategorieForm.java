...
public class AddCategorieForm extends BaseForm{
 ...
 partage.addActionListener((e) -> {
     ...
     if (role.equals("[ROLE_CLIENT, ]"))
     {
        ...
        TextField libelleCategorie = new TextField(""," entrer LibelleCategorie");
        ...
        Button btnAjouter = new Button("Ajouter");
         addStringValue("", btnAjouter);
            ...
            public void actionPerformed(ActionEvent evt) {
                try{
                if ((libelleCategorie.getText().equals("")))
            ...
            Categorie s = new Categorie(
                    String.valueOf(libelleCategorie.getText())
                   
                    );
                    System.err.println("data categorie=="+s);
                    ServiceCategorie.getInstance().ajoutCategorie(s);
                    idialog.dispose();
                   Dialog.show("Succes", "Categorie ajouter avec succes ", new Command("OK"));
