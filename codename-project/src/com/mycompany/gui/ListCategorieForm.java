...
String role = SessionManager.getRoles();
     if (role.equals("[ROLE_CLIENT, ]"))
     {
        ...
        ArrayList<Categorie>list = ServiceCategorie.getInstance().ShowCats();
    ...
    private void addButton(Image img,Categorie rec , Resources res) {
        ...
        Label LibelleCategorieTxt = new Label("libelle categorie : "+rec.getLibelleCategorie(),"NewsTopLine2" );
     ...
     if (role.equals("[ROLE_CLIENT, ]"))
     {
         cnt.add(BorderLayout.NORTH,BoxLayout.encloseY(
                ...
                BoxLayout.encloseX(LibelleCategorieTxt)));
        ...
        lSupprimer.addPointerPressedListener(l -> {
           ...
           ServiceCategorie.getInstance().deleteCategorie(rec.getId()); 
            Dialog.show("Success", "Categorie Deleted Successfully.", "OK", "Cancel");
        ...
        cnt.add(BorderLayout.NORTH,BoxLayout.encloseY(
                ...
                BoxLayout.encloseX(LibelleCategorieTxt,lModifier,lSupprimer)));
