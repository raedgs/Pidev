...
public class AjoutLivraisonForm extends BaseForm{
 ...
 partage.addActionListener((e) -> {
        ...
        TextField lieux = new TextField("", "entrer lieux!!");
        lieux.setUIID("TextFieldBlack");
        addStringValue("lieux",lieux);
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try {
                ...
                if(lieux.getText().equals("") ) {
                    ...
                    Livraison r = new Livraison(String.valueOf(lieux.getText()).toString(),format.format(new Date()));
                              
                    
                    System.out.println("data  Livraison == "+r);
                    
                    
                    //appelle methode ajouterLivraison mt3 service Livraison bch nzido données ta3na fi base 
                    ServiceLivraison.getInstance().ajouterLivraison(r);
                    
                    iDialog.dispose(); //na7io loading ba3d ma3mlna ajout
                    
                    //ba3d ajout net3adaw lel ListLivraisonForm
