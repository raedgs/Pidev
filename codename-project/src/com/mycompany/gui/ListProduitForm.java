...
public class ListProduitForm extends BaseForm{
 ...
 String role = SessionManager.getRoles();
     if (role.equals("[ROLE_CLIENT, ]"))
     {
        ...
        bindButtonSelection(mesListesP, arrow);
        ...
        ArrayList<Produit>list = ServiceProduit.getInstance().ShowProds();
    ...
    private void addButton(Image img,Produit rec , Resources res) {
        ...
        Label LibelleTxt = new Label(rec.getLibelle(),"NewsTopLine2" );
        Label DescriptionTxt = new Label(rec.getDescription(),"NewsTopLine2" );
     ...
     if (role.equals("[ROLE_CLIENT, ]"))
     {
         cnt.add(BorderLayout.NORTH,BoxLayout.encloseY(
                ...
                BoxLayout.encloseX(LibelleTxt,DescriptionTxt,prix)));
     ...
     else 
     {
        ...
        lSupprimer.addPointerPressedListener(l -> {
           ...
           ServiceProduit.getInstance().DeleteProd(rec.getIdproduit()); 
      ...
      new ModifierProduitForm(res,rec).show();
        ...
        cnt.add(BorderLayout.NORTH,BoxLayout.encloseY(
                ...
                BoxLayout.encloseX(LibelleTxt,DescriptionTxt,prix,lModifier,lSupprimer)));
